...
namespace AutoMeetsUI
{
	...
	public class AnimateSlideInFromLeftMarginProperty : AnimateBaseProperty<AnimateSlideInFromLeftMarginProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
				// Animate in
				await element.SlideAndFadeInFromLeftAsync(FirstLoad ? 0 : 0.3f, keepMargin: true);
			else
				// Animate out
	...
	/// Animates a framework element sliding it in from the left on show and sliding out to the left on hide
	/// </summary>
	public class AnimateSlideandNoFadeInFromLeftProperty : AnimateBaseProperty<AnimateSlideandNoFadeInFromLeftProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
	...
	#region Animate Right

	/// <summary>
	/// Animates a framework element sliding it in from the right on show and sliding out to the left on right
	/// </summary>
	...
	public class AnimateSlideInFromRightMarginProperty : AnimateBaseProperty<AnimateSlideInFromRightMarginProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
				// Animate in
				await element.SlideAndFadeInFromRightAsync(FirstLoad ? 0 : 0.3f, keepMargin: true);
			else
				// Animate out
				await element.SlideAndFadeOutToRightAsync(FirstLoad ? 0 : 0.3f, keepMargin: true);
		}
	}
	...
	/// Animates a framework element sliding it in from the right on show and sliding out to the left on right
	/// </summary>
	public class AnimateSlideandNoFadeInFromRightProperty : AnimateBaseProperty<AnimateSlideandNoFadeInFromRightProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
	...
	/// Animates a framework element sliding up from the bottom on show and sliding out to the bottom on hide
	/// </summary>
	public class AnimateSlideandNoFadeInFromBottomProperty : AnimateBaseProperty<AnimateSlideandNoFadeInFromBottomProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
				...
				// Animate out
				await element.SlideOutToBottomAsync(FirstLoad ? 0 : 0.3f, keepMargin: false);
		}
	}
	...
	/// <summary>
	/// Animates a framework element sliding up from the top on show and sliding out to the top on hide
	/// </summary>
	public class AnimateSlideInFromTopProperty : AnimateBaseProperty<AnimateSlideInFromTopProperty>
	{
		protected override async void DoAnimation(FrameworkElement element, bool value)
		{
			if (value)
				...
				// Animate out
				await element.SlideAndFadeOutToTopAsync(FirstLoad ? 0 : 0f, keepMargin: false);
		}
	}
